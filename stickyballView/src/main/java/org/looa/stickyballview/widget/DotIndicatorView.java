...
import org.looa.stickyballview.utils.DimensionUtil;


/**
 * For better performance, we recommend using wrap_content.
...
public class DotIndicatorView extends RelativeLayout implements ViewPager.OnPageChangeListener {
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        colorSelected = ta.getColor(R.styleable.DotIndicatorView_color_selected, DEFAULT_COLOR_SELECTED);
        colorUnSelected = ta.getColor(R.styleable.DotIndicatorView_color_unselected, DEFAULT_COLOR_UNSELECTED);
        dotCenterDistance = ta.getDimensionPixelSize(R.styleable.DotIndicatorView_dot_center_distance, DEFAULT_DOT_SPACING);
        dotRadius = ta.getDimensionPixelSize(R.styleable.DotIndicatorView_dot_radius, DEFAULT_DOT_RADIUS);
    ...
    private int measureHeight(int heightMeasureSpec) {
        ...
        if (mode == MeasureSpec.AT_MOST) result = paddingTop + paddingBottom + dotRadius * 2;
        return result;
    }
